...
function cm_custom_post_type_register() {

    $labels = array(
        'name'                  => _x( 'Custom Post', 'Post Type General Name', 'text_domain' ),
    ...
    $args = array(
        ...
        'description'           => __( 'Custom Post', 'text_domain' ),
        'labels'                => $labels,
...
add_action( 'init', 'cm_custom_post_type_register', 0 );
